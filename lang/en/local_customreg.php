...
$string['downloadcsv'] = 'CSV';
$string['downloadtsv'] = 'TSV (Tab-separated)';
$string['downloadhtml'] = 'HTML Table';
$string['downloadods'] = 'ODS Spreadsheet';
$string['no_records'] = 'No records found.';
$string['csv_firstname'] = 'First Name';
$string['csv_lastname'] = 'Last Name';
$string['csv_email'] = 'Email';
$string['csv_studentid'] = 'Student ID';
